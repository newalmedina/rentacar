<div style="overflow-x: auto; width: 100%;">
    <table class="w-full border-collapse border border-gray-300 min-w-[700px]">
        <thead>
            <tr class="font-bold">
        ...
        <tfoot>
            <tr class="font-bold">
                ...
                <td class="border border-gray-300 px-2 py-1">{{ number_format($orderDetails->sum('total_base_price'), 2) }}</td>
                <td></td>
                <td class="border border-gray-300 px-2 py-1">{{ number_format($orderDetails->sum('taxes_amount'), 2) }}</td>
                <td class="border border-gray-300 px-2 py-1">{{ number_format($orderDetails->sum('total_with_taxes'), 2) }}</td>
            </tr>
        </tfoot>
    </table>
</div>
